...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setTitle('Verify Section')
            .setDescription(`Press the green check button below to verify`)
            .setImage('https://cdn.discordapp.com/attachments/1320314372123529236/1335444273537089586/standard_1.gif?ex=67be8366&is=67bd31e6&hm=a5c58f0ec3b9afc04cf95ac4c7f4daf4486babf0b5bf6e6c114ae2989b4aba77&')
